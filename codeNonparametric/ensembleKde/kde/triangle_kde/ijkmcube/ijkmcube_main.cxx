...
int main(int argc, char **argv)
{
  ...
  try {
    ...
    // Read the mean (fileName.nrrd) and all ensemble members+kde bandwidth (2_fileName.nrrd)
...
{         
  ...
  for (int i = 0; i < io_info.isovalue.size(); i++) {
	...
	if(interpolation_type == 0)
      ...
      // change      
	// Pass mean (mc_data) and ensemble (mc_data_1) grids to the marching cubes function and get colors in f_color array 
